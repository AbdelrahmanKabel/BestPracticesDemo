using BestPracticesDemo.Domain.Common;
...
namespace BestPracticesDemo.Persistence
{
    public class BestPracticesDbContext : DbContext
    {
        ...
        public BestPracticesDbContext(DbContextOptions<BestPracticesDbContext> options) : base(options)
        {
        }
        ...
        {
            modelBuilder.ApplyConfigurationsFromAssembly(typeof(BestPracticesDbContext).Assembly);
